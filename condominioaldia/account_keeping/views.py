...
class BankAccountsViewSet(CreateListRetrieveViewSet, mixins.DestroyModelMixin, mixins.UpdateModelMixin):
...
class TransactionViewSet(CreateListRetrieveViewSet, mixins.DestroyModelMixin, mixins.UpdateModelMixin):
    ...
    def get_queryset(self, *args, **kwargs):
        if self.request.user.is_condo:
            return self.queryset.filter(account__user= self.request.user, account= self.kwargs.get('account_pk'))
        elif self.request.user.is_resident:
