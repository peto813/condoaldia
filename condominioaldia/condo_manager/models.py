...
from .managers import UserManager, InmuebleManager
from .validators import validate_postitive
from rolepermissions.checkers import has_permission, has_role
from condominioaldia.roles import (
    Condo as CondoRole, Resident as ResidentRole, Rentee as RenteeRole
)
...
class Resident(models.Model):
    ...
    terms_accepted = models.BooleanField(
        null=True, default=False, verbose_name=_('Terms')
    )
    ...
    def send_welcome_email(self, inmueble):
        ...
        subject = loader.render_to_string(
            'account/email/resident_welcome_subject.txt',
            {'condo_name': condo_name}
        )
        message = loader.render_to_string(
            'account/email/resident_welcome_message.txt', {
        ...
        self.user.email_user(
            subject, message, fromEmail, emailList, fail_silently=False
        )
...
class Inmueble(models.Model):
    ...
    resident = models.ForeignKey(Resident, blank = False, null= True,related_name = 'inmuebles', on_delete = models.SET_NULL,)
