    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Approval date')),
                ...
                ('terms_accepted', models.BooleanField(default=False, verbose_name='Terms')),
                ('active', models.BooleanField(default=False, help_text='Condominiums will be deactivated when percentage falls below 99.75')),
            ],
        ),
        migrations.CreateModel(
            name='Inmueble',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('share', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=10, verbose_name='percentage representation')),
                ('rented', models.BooleanField(default=False, verbose_name='leased')),
                ('initial_balance', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=50, null=True, verbose_name='initial balance')),
                ('board_position', models.CharField(blank=True, max_length=20, null=True, verbose_name='board position')),
                ('balance', models.DecimalField(decimal_places=4, default=0, max_digits=25, verbose_name='current debt')),
                ('name', models.CharField(help_text='House number or name; apartment number, etc', max_length=20, null=True, verbose_name='Property name')),
                ('board_member', models.BooleanField(default=False, verbose_name='board member')),
                ('created', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Created')),
                ('condo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='condo_inmuebles', to='condo_manager.Condo', verbose_name='Condominium')),
        ...
        migrations.AddField(
            model_name='inmueble',
            name='resident',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resident_inmuebles', to='condo_manager.Resident'),
        ),
        migrations.AddField(
            model_name='condo',
            name='residents',
