from .models import Condo, Resident, Rentee, Inmueble
...
class ResidentForm(forms.ModelForm):
    '''
    Django form class that creates resident record
    Commonly used from the Admin site
    '''
    inmueble = forms.ModelChoiceField(queryset=Inmueble.objects.all(), required=True)
    class Meta:
        model = Resident
        fields = '__all__'
...
class CondoForm(forms.ModelForm):
    '''
    Django form class that creates condominium record
    Commonly used from the Admin site
    '''
